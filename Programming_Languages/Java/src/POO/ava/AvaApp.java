...
//            switch (opcao){
//                case 1:
//                    if(gerenciamento.limMaxDeAlunosAtingido()) { // verifica se ainda tem vagas na turma
...
//                        }
//
//                        if(media >= 7){ situacao = true;}
//
//                        gerenciamento.AddAluno(nome, idade, periodo, media, sexo, situacao);
//
//                        JOptionPane.showMessageDialog(null, " Aluno(a) "+ nome + " adicionado com sucesso!");
//                    }
//                    else {
//                        JOptionPane.showMessageDialog(null, " Limite de alunos atingido! ");
//                    }
//                    break;
//
//                case 2:
