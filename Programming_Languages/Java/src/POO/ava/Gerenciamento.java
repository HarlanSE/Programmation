...
public class Gerenciamento {
    ...
    static public int MATRICULA = 569782, TAMTURMA = 5;
    ...
    // Adicionar
    public void AddAluno(String nome, int idade, int periodo, float media, char sexo, boolean situacao) {
...
// buscar interno
    ...
    public boolean limMaxDeAlunosAtingido(){
